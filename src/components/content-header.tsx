...
export const HeroSection = () => {
  return (
    <div className="w-1/2 h-[70px]  w-full">
      <h1 className="text-blue-500 font-bold  text-[28px] leading-10">
        복잡한 공공데이터, 하나의 통합된 플랫폼에서
      </h1>
      <h2 className="text-xl font-semibold text-gray-500 text-left -mt-1 text-[20px]">
...
export const ProgressSection = () => {
  ...
  return (
    <div className="w-full h-[100px] bg-white border-1 border-gray-400 rounded-lg flex flex-col px-3 py-2 justify-center">
